"""Bridge StoryMind playbooks → HyperFrames-friendly style artifacts.

StoryMind playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by StoryMind HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
