...
**This file** teaches how StoryMind uses Remotion — which compositions map to pipeline
...
| StoryMind Artifact | Remotion Prop | Maps To |
|---------------------|---------------|---------|
...
| StoryMind Profile | Remotion Config |
|--------------------|-----------------|
