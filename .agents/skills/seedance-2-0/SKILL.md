...
| Surface | Env | StoryMind tool | Status | Notes |
|---|---|---|---|---|
| **fal.ai** (primary) | `FAL_KEY` | `seedance_video` | ✅ wrapped | Model IDs below. Supports T2V, I2V, reference-to-video; `standard` and `fast` variants. Default in StoryMind. |
...
## Calling Seedance 2.0 inside StoryMind
...
## Integration notes for StoryMind pipelines
