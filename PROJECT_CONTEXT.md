# StoryMind - Shared Project Context
...
StoryMind is an open-source, AI-orchestrated video production platform.
...
Layer 2: skills/                    → "How StoryMind uses them" (project conventions)
...
| `skills/core/hyperframes.md` | Layer 2 — when StoryMind should pick HyperFrames vs Remotion, artifact → workspace mapping |
